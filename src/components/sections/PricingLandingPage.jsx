// File: src/components/sections/PricingLandingPage.jsx
// Pricing versi landing page: card-based, expandable features, props untuk judul & WA.
...
// ⬇️ Harga diperkecil:  text-2xl md:text-3xl & font-bold (dari sebelumnya text-3xl md:text-4xl & font-extrabold)
...
function PlanCard({ data, maintenance = false, whatsapp }) {
  ...
  const waHref = `https://wa.me/${whatsapp}?text=${encodeURIComponent(
    `Halo Devsomnia, saya minat paket ${data.name}`
  )}`;
