...
export default function Backlink() {
  return (
    <>
      <title>Jasa Backlink – Devsomnia</title>
      <meta
        name="description"
        content="Layanan Backlink Devsomnia saat ini sudah penuh. Silakan kembali ke halaman utama atau cek layanan lainnya."
      />

      <section className="flex flex-col items-center justify-center text-center min-h-[70vh] px-6">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6">
          Layanan Backlink Saat Ini Penuh 🚫
        </h1>
        <p className="text-lg text-gray-600 max-w-xl mb-10">
          Terima kasih atas minat Anda. Untuk sementara, layanan Backlink Devsomnia
